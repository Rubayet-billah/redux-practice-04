    ...
    <div className="flex justify-center mt-8">
      <div className="bg-green-200 text-center p-6 rounded-md">
        ...
        <button
          ...
          className="bg-gradient-to-r from-blue-500 to-violet-400 px-5 py-2 m-4 rounded-md text-white"
        >
          Decrement
        </button>
        <button
          onClick={() => dispatch({ type: "INCREMENT", payload: { count: 5 } })}
          className="bg-gradient-to-r from-red-500 to-pink-400 px-5 py-2 m-4 rounded-md text-white"
        >
          Increment
        </button>
      </div>
